def main():
    ...
    starting_x, starting_y, starting_direction = x, y, direction
    possible_obstacles = 0

    for i in range(len(lines)):
        for j in range(len(lines[i])):
            if lines[i][j] == "#" or lines[i][j] in ["^", ">", "v", "<"]:
                continue

            visited = set()
            x, y, direction = starting_x, starting_y, starting_direction
            ...
            while True:
                ...
                if next == "#" or next_x == i and next_y == j:
